...
class MessageTab:
    ...
    def _build_message_section(self, parent: ctk.CTkFrame):
        ...
        self.subject_entry = ctk.CTkEntry(parent, height=40, font=("Segoe UI", 12))
        ...
        self.body_text = ctk.CTkTextbox(parent, font=("Segoe UI", 12), wrap="word")
